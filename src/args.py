...
def add_train_args(parser):
    ...
    parser.add_argument("--STAGE1_G_path",
                        type=str,
                        default="../output/model/netG_epoch_600.pth",
    ...
    parser.add_argument("--datapath",
                        type=str,
                        default="E:\StackGAN-BERT\output2",
                        help="datapath dir")
    parser.add_argument("--image_save_dir",
                        type=str,
                        default="E:\StackGAN-BERT\output2\image",
                        help="Image save dir")
    parser.add_argument("--model_dir",
                        type=str,
                        default="E:\StackGAN-BERT\output2\model",
                        help="Model save dir")
    parser.add_argument("--log_dir",
                        type=str,
                        default="E:\StackGAN-BERT\output2\log",
